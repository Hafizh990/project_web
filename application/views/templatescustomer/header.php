               ...
               <ul class="metismenu" id="menu">
                    ...
                    <li>
                         <a class="has-arrow" href="javascript:;">
                              ...
                              <div class="menu-title">HISTORY TOP-UP</div>
                         </a>
                         <ul>
                              <li><a href="<?= base_url('customer/historysaldo') ?>"><ion-icon name="ellipse-outline"></ion-icon>Riwayat Isi Ulang Saldo</a>
                              </li>
                         </ul>
                    </li>
                    <li>
                         ...
                         <ul>
                              <li><a href="<?= base_url('customer/historypesanan') ?>"><ion-icon name="ellipse-outline"></ion-icon>Pesanan Customer</a>
                              </li>
                         </ul>
                    </li>
               </ul>
                         ...
                         <ul class="navbar-nav align-items-center">
                              ...
                              <li class="nav-item dropdown dropdown-user-setting">
                                   ...
                                   <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                             <a class="dropdown-item" href="#">
                                                  <div class="d-flex flex-row align-items-center gap-2">
                                                       ...
                                                       <div class="">
                                                            <p class="mb-0 dropdown-user-name"><?php echo $this->session->userdata('nama_customer') ?></p>
                                                            <small class="mb-0 dropdown-user-designation text-secondary">Customer</small>
                                                       </div>
                                                  </div>
                                             </a>
                                        </li>
                                        ...
                                        <li>
                                             <a class="dropdown-item" href="<?= base_url('customer/authcustomer/logout') ?>">
