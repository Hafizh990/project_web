     ...
     <div class="wrapper">
          ...
          <aside class="sidebar-wrapper" data-simplebar="true">
               ...
               <ul class="metismenu" id="menu">
                    <li>
                         <a href="<?= base_url('driver/dashboard') ?>">
                    ...
                    <li>
                         ...
                         <ul>
                              <li><a href="<?= base_url('driver/pesanan') ?>"><ion-icon name="ellipse-outline"></ion-icon>Riwayat Pesanan</a>
                              </li>
                         </ul>
                    </li>
               </ul>
                         ...
                         <ul class="navbar-nav align-items-center">
                              ...
                              <li class="nav-item dropdown dropdown-user-setting">
                                   ...
                                   <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                             <a class="dropdown-item" href="#">
                                                  <div class="d-flex flex-row align-items-center gap-2">
                                                       ...
                                                       <div class="">
                                                            <p class="mb-0 dropdown-user-name"><?php echo $this->session->userdata('nama_driver') ?></p>
                                                            <small class="mb-0 dropdown-user-designation text-secondary">Driver</small>
                                                       </div>
                                                  </div>
                                             </a>
                                        </li>
                                        ...
                                        <li>
                                             <a class="dropdown-item" href="<?= base_url('driver/authdriver/logout') ?>">
