                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto mt-5">
                         <div class="card radius-10">
                              <div class="card-body p-4">
                                   ...
                                   <form action="<?= site_url('customer/authcustomer') ?>" method="post" class="form-body row g-3 mt-2">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 col-lg-12 text-center">
                                             <p class="mb-0">Don't have an account? <a href="<?= base_url('customer/register') ?>">Sign up</a></p>
                                        </div>
                                   </form>
                              </div>
                         </div>
