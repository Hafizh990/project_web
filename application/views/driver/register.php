                    ...
                    <div class="col-xl-6 col-lg-5 col-md-7 mx-auto mt-5">
                         <div class="card radius-10">
                              <div class="card-body p-4">
                                   ...
                                   <form action="<?= site_url('driver/register') ?>" method="post" class="form-body row g-3 mt-2">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                             ...
                                             <input type="text" name="nama_driver" value="<?= set_value('nama_driver'); ?>" class="form-control" id="email">
                                             <?= form_error('nama_driver', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 col-lg-12 text-center">
                                             <p class="mb-0">Already an account? <a href="<?= base_url('driver/authdriver') ?>">Login</a></p>
                                        </div>
                                   </form>
                              </div>
                         </div>
