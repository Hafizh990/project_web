...
class Authdriver extends CI_Controller
{
     ...
     public function index()
     {
          ...
          if ($this->form_validation->run() == FALSE) {
               ...
               $this->load->view('driver/authdriver', $data);
          } else {
               $email         = $this->input->post('email');
               $password      = $this->input->post('password');

               $cek = $this->Mdl_gotrash->cek_login_driver($email, $password);
               ...
               if ($cek == FALSE) {
                    ...
                    $this->session->set_userdata('nama_driver', $cek->nama_driver);
                    $this->session->set_userdata('email', $cek->email);
                    $this->session->set_userdata('id_driver', $cek->id_driver);
